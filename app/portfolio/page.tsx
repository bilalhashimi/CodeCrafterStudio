      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {tags.map((tag, i) => (
            <span 
              key={i} 
              className="px-3 py-1 bg-white/10 text-gray-200 rounded-full text-xs font-medium"
            >
              {tag}
            </span>
          ))}
...
export default function PortfolioPage() {
  ...
  return (
    <>
      <NavBar />
      <main className="min-h-screen pt-20 bg-gradient-to-br from-[#0e0639] via-[#1b0d4e] to-[#17083b] text-white relative overflow-hidden">
        {/* Background elements */}
